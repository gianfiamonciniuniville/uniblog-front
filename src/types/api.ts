...
export interface LikeDto {
  id: number;
  postId: number; // Added postId to LikeDto for clarity
  userId: number; // Added userId to LikeDto for clarity
  // The OpenAPI spec suggests LikeCreateDto includes userId.
  // The backend will likely return the full LikeDto with userId when fetching.
}
