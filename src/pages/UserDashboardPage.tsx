...
const UserDashboardPage: React.FC = () => {
  ...
  const handleDeletePost = (postId: number) => {
    ...
    toaster.info("Delete Post functionality not yet fully implemented on dashboard.");
  };
  ...
  const handleDeleteBlog = (blogId: number) => {
    ...
    toaster.info("Delete Blog functionality not yet fully implemented on dashboard.");
  };
      ...
      <VStack spacing={8} align="stretch">
        ...
        <Box>
          <Flex justifyContent="space-between" alignItems="center" mb={4}>
            <Heading as="h2" size="lg">Your Posts</Heading>
        ...
        <Box>
          <Flex justifyContent="space-between" alignItems="center" mb={4}>
            <Heading as="h2" size="lg">Your Blogs</Heading>
            <Button variant="primary" onClick={() => navigate("/blogs/create")}>
              Create New Blog
            </Button>
          </Flex>
          {userBlogs.length > 0 ? (
